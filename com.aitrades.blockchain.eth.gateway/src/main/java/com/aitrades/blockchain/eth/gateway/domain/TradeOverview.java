...
public class TradeOverview {
	...
	public String getContractIntreactedWith() {
		return contractIntreactedWith;
	}
	public void setContractIntreactedWith(String contractIntreactedWith) {
		this.contractIntreactedWith = contractIntreactedWith;
	}
